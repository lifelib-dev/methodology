...
# nested.py converted to a modelx model - Approach 2
...
Term.term_m_init = 120      # Make term_m a cells
Term.premium = 1300
Term.sum_assured = 100_000
Term.start_age_init = 30    # Make start_age a cells
...
PrudentTerm.parameters = ('t0',)


@mx.defcells
def term_m():
    # Note:
    # _space                          represents RealisticTerm.PrudentTerm[t0]
    # _space._parent                  represents RealisticTerm.PrudentTerm
    # _space._parent._parent          represents RealisticTerm
    #
    # So to set term_m to term_remaining at t0 in RealisticTerm:
    return _space._parent._parent.term_remaining(t0)

@mx.defcells
def start_age():
    # Same applies here as term_m():
    return _space._parent._parent.age(t0)
